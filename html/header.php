        ...
        <ul id="nav-header">
            ...
            <li>
                ...
                <ul class="subnavclass11">
                    <li><a id="_11_1" href="./review.php?level=11&chapter=1">Chương 1: Điện tích. Điện trường</a>
                    </li>
                    ...
                    <li><a id="_11_7" href="./review.php?level=11&chapter=7">Chương 7: Mắt. Các Dụng Cụ Quang</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul class="subnavclass12">
                    ...
                    <li><a id="_12_2" href="./review.php?level=12&chapter=2">Chương 2: Sóng Cơ và Sóng Âm</a></li>

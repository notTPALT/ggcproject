            ...
            <table class="tableStyle">
                <tr>
                    ...
                    <td><button id="btnAddAdmin" style="height: 30px; background-color: #4CAF50; padding: 5px 10px; color: white;
                                border: none; height: 30px; border-radius: 5px; cursor: pointer;">Thêm tài khoản admin</button></td>
                </tr>
                <?php 
                    ...
                    while($res = mysqli_fetch_array($tmp)){ ?>
                        <tr id="<?php echo $res['id'];?>">
                            ...
                            <td><input type="button" value="Sửa" style="background-color: #FFD700;" onclick="updateAdmin(<?php echo $res['id']; ?>)"></td>
                            <td><input type="button" value="Xóa" style="background-color: red;" onclick="deleteAdmin(<?php echo $res['id']; ?>)"></td>
                        </tr>
                    <?php
                    }
                    ?>

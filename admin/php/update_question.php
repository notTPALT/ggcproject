    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        ...
        ?>
            ...
            <td style="width: 5%;">Câu hỏi.</td>
                <td style="width: 30%;"><textarea name="question" rows="4" cols="50" required><?php echo $res['question']; ?></textarea></td>
            </tr>
            <tr>
                <td style="width: 5%;">Đáp án A.</td>
                <td style="width: 30%;"><textarea name="option_a" rows="2" cols="50" required><?php echo $res['option_a']; ?></textarea></td>
            </tr>
            <tr>
                <td style="width: 5%;">Đáp án B.</td>
                <td style="width: 30%;"><textarea name="option_b" rows="2" cols="50" required><?php echo $res['option_b']; ?></textarea></td>
            </tr>
            <tr>
                <td style="width: 5%;">Đáp án C.</td>
                <td style="width: 30%;"><textarea name="option_c" rows="2" cols="50" required><?php echo $res['option_c']; ?></textarea></td>
            </tr>
            <tr>
                <td style="width: 5%;">Đáp án D.</td>
                <td style="width: 30%;"><textarea name="option_d" rows="2" cols="50" required><?php echo $res['option_d']; ?></textarea></td>
            </tr>
                <td>Đáp án đúng.</td>

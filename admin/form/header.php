  ...
  <div style="display: flex; align-items: center; justify-content: space-between; background-color: #B8860B; padding: 10px;">
    ...
    <div style="text-align: right;">
      ...
      <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <input type="submit" name="logout" value="Đăng xuất" style="height: 20px; padding: 5px 10px; background-color: red; color: white; border: none; border-radius: 3px; cursor: pointer;">
      </form>
    </div>
  </div>
</header>
